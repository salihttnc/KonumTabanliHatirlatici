 ...
 */
public class TodayWeatherFragment1 extends Fragment {
    ...
    static TodayWeatherFragment1 instance;

    public static TodayWeatherFragment1 getInstance() {
        if(instance==null)
            instance=new TodayWeatherFragment1();
        return instance;
    }

    public TodayWeatherFragment1() {
    ...
    private void getWeatherInformation() {
        ...
        compositeDisposable.add(mService.getWeatherByLating(String.valueOf(Common1.current_location.getLatitude()),
                String.valueOf(Common1.current_location.getLongitude()),
                Common.APP_ID,
                "metric")
