...
public class Maps2Activity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Places.initialize(getApplicationContext(), "AIzaSyAw7gt4lirEIEQHQQ8_956H-JWk8i1p8bM");
    ...
    private class GeocoderTask extends AsyncTask<String, Void, List<Address>> {
        ...
        protected void onPostExecute(List<Address> addresses) {
            ...
            if(addresses==null || addresses.size()==0){
                Toast.makeText(Maps2Activity.this, "No Location found", Toast.LENGTH_SHORT).show();
            }
